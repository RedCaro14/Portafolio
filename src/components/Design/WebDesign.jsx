...
export default function EditorialDesignList() {
  ...
  return (
    <section
      className="w-full max-w-full min-h-[70vh] flex flex-row bg-inherit overflow-hidden"
      style={{ height: "calc(100vh - 110px)" }}
    >
      {/* Panel imagen fijo mitad izquierda desktop */}
      <div className="hidden md:flex w-1/2 h-full flex items-stretch justify-stretch">
        <img
      ...
      {/* Lista 50% desktop, 100% móvil */}
      <div className="w-full md:w-1/2 h-full flex flex-col px-8 py-12 relative">
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          <ul className="flex flex-col gap-10">
            {projects.map((p, idx) => (
              ...
              >
                {/* Imagen visible SOLO en móvil, primero y en fila independiente */}
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                  <div className="flex flex-col flex-1">
                    <a
                      ...
                      style={{
                        textDecoration: activeIdx === idx ? "underline" : "none",
                      }}
                    >
                      {p.title}
                    </a>
